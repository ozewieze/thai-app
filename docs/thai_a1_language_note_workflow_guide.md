...
- **Geaspireerde medeklinkers behouden hun h.** ข/ค → *kh*, ถ/ท → *th*, ผ/พ → *ph* — nooit vereenvoudigen tot *k*, *t*, *p*. Waarom dit expliciet vermeld staat: dit is in het verleden structureel misgegaan (167 vocabulairerijen en 19 dialoogblokken moesten gecorrigeerd worden). Het onderscheid is voor de uitspraak wezenlijk: ปา en พา zijn verschillende woorden.
