# Illustration Prompt — a1_dialog_02 / Slide 2
...
- Slide Specification: `slide-specs/a1_dialog_02_slide_specs.md` → Slide 2

## Verplicht mee te sturen referentieafbeeldingen (niet optioneel)

1. `public/hero-image.png` — stijl-/paletreferentie
2. Face lock-referenties van Mali en Narin (front + 3/4 + profiel). Narin leunt licht naar Mali toe met een uitnodigend gebaar — driekwart is hier de belangrijkste hoek, stuur alle drie mee.
...
4. Vorige goedgekeurde slide van deze dialoog: `slide-00.png` — continuïteitsreferentie (zelfde scène, net iets eerder in het gesprek).
...
Moment: Narin invites Mali to drink coffee together; she accepts. Narin
makes a small, open, inviting gesture (e.g. an open hand toward a shared
direction); Mali responds with a warm nod or small smile of agreement.
Narin slightly leaning in, open and hopeful posture; Mali receptive,
relaxed, nodding in agreement. Narin hopeful and friendly; Mali pleasantly
agreeable, a small warm smile. Rising warmth — the invitation makes the
exchange a little more personal, still fully polite.
...
3. Zetten in `illustration-staging/a1-dialog-02/slide-01.png`.
4. Uploaden via `scripts/upload-slides.mjs` (Stap 7-8) → pad `illustrations/dialogs/a1/dialog-02/slides/slide-01.png`, werkt `dialog_slides.image_url` bij voor `slide_index = 1`.
