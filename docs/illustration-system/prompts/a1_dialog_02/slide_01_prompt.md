# Illustration Prompt — a1_dialog_02 / Slide 1
...
- Slide Specification: `slide-specs/a1_dialog_02_slide_specs.md` → Slide 1

## Verplicht mee te sturen referentieafbeeldingen (niet optioneel)

1. `public/hero-image.png` — stijl-/paletreferentie
2. Face lock-referenties van Mali en Narin (front + 3/4 + profiel). Dit Moment is een terloopse vraag-antwoord terwijl beiden nog grotendeels naar elkaar toe gekeerd staan — driekwart is hier de belangrijkste hoek, stuur alle drie mee.
...
4. n.v.t. — dit is de eerste slide van deze dialoog, geen vorige slide binnen `a1_dialog_02` om als continuïteitsreferentie te gebruiken. (Optioneel, niet verplicht: omdat dialoog 2 direct aansluit op dialoog 1 kan de laatste goedgekeurde slide van `a1_dialog_01` meegestuurd worden als extra locatie-/sfeercontinuïteit.)
...
Moment: Narin asks Mali where she is headed; she answers that she is going
to drink coffee. Narin turns toward Mali with a light, curious question;
Mali answers easily, perhaps with a small gesture toward the direction she
means. Relaxed, upright postures, comfortable conversational distance — a
natural continuation of their earlier first meeting, now more at ease with
each other. Narin friendly and curious; Mali casual and open. Light,
easy-going continuation — comfortable small talk between two people who
have just met.
...
3. Zetten in `illustration-staging/a1-dialog-02/slide-00.png`.
4. Uploaden via `scripts/upload-slides.mjs` (Stap 7-8) → pad `illustrations/dialogs/a1/dialog-02/slides/slide-00.png`, werkt `dialog_slides.image_url` bij voor `slide_index = 0`.
