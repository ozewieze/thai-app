# Illustration Prompt — a1_dialog_03 / Slide 2
...
- Slide Specification: `slide-specs/a1_dialog_03_slide_specs.md` → Slide 2

## Verplicht mee te sturen referentieafbeeldingen (niet optioneel)

1. `public/hero-image.png` — stijl-/paletreferentie
2. Face lock-referenties van Mali en Narin (front + 3/4 + profiel). Narin leunt hier licht naar voren met een verduidelijkingsvraag terwijl Mali beslist antwoordt — driekwart blijft de belangrijkste hoek, stuur alle drie mee.
...
Moment: Narin follows up by asking whether Mali wants her coffee hot or
iced; she specifies iced coffee. Narin tilts his head slightly, perhaps a
small either/or hand gesture suggesting two options; Mali answers promptly
and decisively, with a small confirming gesture of her own. Same seated
postures as the previous slide, continuing moments later; Narin leaning in
slightly with genuine attentiveness, Mali relaxed and clear as she states
her preference. Narin curious and helpful; Mali certain, with a small
pleasant smile. Light continuation, the natural back-and-forth of ordering
— still calm and polite.
...
3. Zetten in `illustration-staging/a1-dialog-03/slide-01.png`.
4. Uploaden via `scripts/upload-slides.mjs` (Stap 7-8) → pad `illustrations/dialogs/a1/dialog-03/slides/slide-01.png`, werkt `dialog_slides.image_url` bij voor `slide_index = 1`.
