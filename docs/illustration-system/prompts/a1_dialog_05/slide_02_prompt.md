# Illustration Prompt — a1_dialog_05 / Slide 2
...
- Slide Specification: `slide-specs/a1_dialog_05_slide_specs.md` → Slide 2
...
4. De goedgekeurde afbeelding van Slide 1 (`slide-00.png`) van dezelfde dialoog — continuïteitsreferentie én **background lock**-referentie (zelfde scène, enkele seconden later; de achtergrond, inclusief alle tafelitems, moet pixelconsistent blijven, niet slechts vergelijkbaar).
...
Moment: Mali asks if Narin likes cake too (a general preference — he has
no cake of his own in front of him); he agrees and turns the question
back with one about ice cream, glancing toward or lightly gesturing at
his own bowl without touching it or pointing at her plate. Mali stays
settled with her own plate and glass, no offering or reaching from
Narin's side; Narin's gaze or light gesture goes toward his own ice cream
as he asks his question. Same seated positions as the previous slide, a
moment later; Narin slightly more animated from asking the counter-
question. Mali curious and expectant; Narin affirming, then genuinely
curious. Light, reciprocal — the conversation bounces naturally back and
forth.
...
3. Zetten in `illustration-staging/a1-dialog-05/slide-01.png`.
4. Uploaden via `scripts/upload-slides.mjs` (Stap 7-8) → pad `illustrations/dialogs/a1/dialog-05/slides/slide-01.png`, werkt `dialog_slides.image_url` bij voor `slide_index = 1`.
