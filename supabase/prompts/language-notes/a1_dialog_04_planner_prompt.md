...
Propose how the concepts of lesson a1-dialog-04 that need explaining
...
## Guideline For This Lesson Phase (sequence_number 4)
...
- **`note_key` follows the fixed convention:** `a1-dialog-04-note-1`,
  `a1-dialog-04-note-2`, numbered in reading order. Lower-case
