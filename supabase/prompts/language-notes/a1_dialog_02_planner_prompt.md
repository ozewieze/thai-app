...
Propose how the concepts of lesson a1-dialog-02 that need explaining
...
## Guideline For This Lesson Phase (sequence_number 2)
...
- **`note_key` follows the fixed convention:** `a1-dialog-02-note-1`,
  `a1-dialog-02-note-2`, numbered in reading order. Lower-case
