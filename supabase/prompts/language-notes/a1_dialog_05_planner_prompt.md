...
Propose how the concepts of lesson a1-dialog-05 that need explaining
...
mali: มะลิ: อร่อยค่ะ เค้กหวาน ชอบขนมหวานค่ะ / Mali: à-rɔ̀i kâ. kéek wǎan. chɔ̂ɔp kà-nǒm wǎan kâ. / Mali: It is delicious. The cake is sweet. I like sweet snacks.
...
## Guideline For This Lesson Phase (sequence_number 5)
...
- **`note_key` follows the fixed convention:** `a1-dialog-05-note-1`,
  `a1-dialog-05-note-2`, numbered in reading order. Lower-case
