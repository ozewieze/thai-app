...
- ชา (chaa) = tea  [key: tea]  ·  noun
- ร้อน (rɔ́ɔn) = hot  [key: hot]  ·  adjective  ·  Used for hot weather, hot objects, food, and drinks.
- เย็น (yen) = cool  [key: cool]  ·  adjective  ·  Used for cool or cold objects, food, and drinks. Also means "evening".
- หรือ (rʉ̌ʉ) = or  [key: or]  ·  conjunction
