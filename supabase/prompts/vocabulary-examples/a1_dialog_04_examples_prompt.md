...
- เอา (ao) = take  [key: take]  ·  verb  ·  Used when taking, choosing, or saying that you want something.
- ด้วย (dûai) = also / too  [key: also]  ·  particle  ·  Placed at the end of a sentence, it means also or too.Also means with or by means of.
- ไม่ (mâi) = no  [key: no]  ·  adverb  ·  Basic negation. Also used in answers and before verbs or adjectives.
- ขนม (kà-nǒm) = snack  [key: snack]  ·  noun
- เค้ก (kéek) = cake  [key: cake]  ·  noun
- ไอศกรีม (ai-sà-griim) = ice cream  [key: ice_cream]  ·  noun
