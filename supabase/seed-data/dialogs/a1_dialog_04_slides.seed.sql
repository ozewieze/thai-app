...
-- a1_dialog_04.seed.sql.
--
-- Segmentatie-bron: docs/illustration-system/slide-specs/a1_dialog_04_slide_specs.md
...
from dialog
cross join (values
  (0, 0, 1), -- Slide 1: Narin biedt een snack aan; Mali stemt toe (blokken 0-1)
  (1, 2, 3), -- Slide 2: Narin vraagt welke snack; Mali kiest cake (blokken 2-3)
  (2, 4, 6)  -- Slide 3: Mali kaatst terug; Narin wijst af en kiest ijs (blokken 4-6)
