...
-- a1_dialog_01.seed.sql -- zelfde principe als
-- seed-data/links/lesson_links_a1-dialog-01.seed.sql, dat ook een
-- aparte, later-in-de-tijd concern is.
--
-- Segmentatie-bron: docs/illustration-system/slide-specs/a1_dialog_01_slide_specs.md
...
from dialog
cross join (values
  (0, 0, 1), -- Slide 1: wederzijdse begroeting (blokken 0-1)
  (1, 2, 3), -- Slide 2: Mali stelt zich voor en vraagt Narins naam (blokken 2-3)
  (2, 4, 6)  -- Slide 3: Narin stelt zich voor; wederzijds "aangenaam" (blokken 4-6)
